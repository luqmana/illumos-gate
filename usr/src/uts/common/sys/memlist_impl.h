 ...
 */
extern int memlist_rsrc_add(uint64_t, uint64_t, struct memlist **);
extern int memlist_rsrc_delete(uint64_t, uint64_t, struct memlist **);
extern int memlist_rsrc_delete_list(struct memlist **, const struct memlist *);
extern int memlist_rsrc_merge(const struct memlist *, struct memlist **);
extern int memlist_rsrc_subsume(struct memlist **, struct memlist **);
